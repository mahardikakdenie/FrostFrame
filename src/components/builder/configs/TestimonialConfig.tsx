  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-left-2 duration-300">
      <div className="flex flex-col gap-1 text-left">
        ...
        <h2 className="text-xl font-black text-slate-900 uppercase italic tracking-tighter">TESTIMONIAL CONFIG</h2>
      </div>

      <div className="space-y-6">
        {/* Quote */}
        <div className="space-y-2 text-left">
          <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest block italic flex items-center gap-1.5">
            <Quote className="w-3 h-3" /> Quote Text
          </label>
          <textarea 
            className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-xs font-bold text-slate-700 outline-none focus:ring-2 focus:ring-indigo-100 h-24 resize-none"
        ...
        <div className="pt-4 border-t border-slate-100 space-y-4">
          <h3 className="text-[10px] font-black text-slate-800 uppercase tracking-widest italic text-left">Author Information</h3>
          ...
          <div className="space-y-2 text-left">
            ...
            <input 
              type="text" 
              className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-xs font-bold text-slate-700 outline-none focus:ring-2 focus:ring-indigo-100"
              value={author.name}
          ...
          <div className="space-y-2 text-left">
            ...
            <div className="flex gap-2 items-center">
              {author.avatar && (
                <img src={author.avatar} alt="Avatar" className="w-10 h-10 rounded-xl object-cover border border-slate-200" />
              )}
              <input 
                type="text" 
        ...
        <div className="pt-4 border-t border-slate-100 space-y-4 text-left">
           <h3 className="text-[10px] font-black text-slate-800 uppercase tracking-widest italic">Partner Logos (Text)</h3>
           <div className="grid grid-cols-2 gap-2">
             {logos.map((logo: string, idx: number) => (
               <input 
                 key={idx}
                 type="text" 
                 className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs font-black uppercase text-slate-700 outline-none focus:ring-2 focus:ring-indigo-100 italic"
                 value={logo}

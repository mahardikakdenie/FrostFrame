...
const ImageComponent = (props: any) => {
  ...
  const { src, alt, borderRadius, objectFit, minHeight, marginTop } = node.attrs;
    ...
    >
      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          (selected || editor.isActive('imageElement')) ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"
        )}>
          <button 
